...
schema_view = get_schema_view(
   openapi.Info(
      title="API Microblading ERP",
      default_version='v1',
      description="Documentación oficial del backend para el E-Commerce y Dashboard",
   ),
   public=True,
...
urlpatterns = [
    ...
    path('dashboard/', include('dashboard.urls')), # Incluir las URLs de la app 'dashboard' 
    
    # Documentación OpenAPI (Swagger y ReDoc)
